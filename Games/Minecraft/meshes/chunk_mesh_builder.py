...
@njit
def pack_data(x, y, z, v_id, f_id, ao_id, flip_id):
    # x: 6, y: 6, z: 6, v_id: 8, f_id: 3, ao_id: 2, flip_id: 1
    a, b, c, d, e, f, g = x, y, z, v_id, f_id, ao_id, flip_id
...
def build_chunk_mesh(chunk_voxels, format_size, chunk_pos, world_voxels):
    vertex_data = np.empty(CHUNK_VOL * 18 * 5 * format_size, dtype='uint32')
    index = 0
